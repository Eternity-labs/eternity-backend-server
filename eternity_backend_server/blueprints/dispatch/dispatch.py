...
def votenode():
    ...
    data_bytes = client.lpop(REDIS_NAME)
    if data_bytes == None:
        return jsonify({"result":"our list is null."})
...
# import redis
# import json
# redisPool = redis.ConnectionPool(host='47.98.100.48', port=6379, db=5)
# client = redis.Redis(connection_pool=redisPool, password="1234!@#$qwer")
#
# client.delete("test")
